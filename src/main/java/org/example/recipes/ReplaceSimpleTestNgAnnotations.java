...
public class ReplaceSimpleTestNgAnnotations extends Recipe {
    ...
    public String getDescription() {
        return String.format("Annotations match TestNg -> JUnit: %n`@Test`: from %s to %s %n'@BeforeMethod': from %s to %s %n '@AfterMethod': from %s to %s %n '@BeforeTestClass': from %s to %s %n '@AfterTestClass': from %s to %s", ORG_TESTNG_ANNOTATIONS_TEST, ORG_JUNIT_JUPITER_API_TEST, ORG_TESTNG_ANNOTATIONS_BEFORE_METHOD, ORG_JUNIT_JUPITER_API_BEFORE_EACH, ORG_TESTNG_ANNOTATIONS_AFTER_METHOD, ORG_JUNIT_JUPITER_API_AFTER_EACH, ORG_TESTNG_ANNOTATIONS_BEFORE_CLASS, ORG_JUNIT_JUPITER_API_BEFORE_ALL, ORG_TESTNG_ANNOTATIONS_AFTER_CLASS, ORG_JUNIT_JUPITER_API_AFTER_ALL);
    }
    ...
    public static class ReplaceSimpleAnnotationsVisitor extends JavaIsoVisitor<ExecutionContext> {
        ...
        public J.CompilationUnit visitCompilationUnit(J.CompilationUnit cu, ExecutionContext executionContext) {
            ...
            // Before test method
            doAfterVisit(new ChangeType(ORG_TESTNG_ANNOTATIONS_BEFORE_METHOD, ORG_JUNIT_JUPITER_API_BEFORE_EACH, false));
